...
```bash
wget -O - https://raw.githubusercontent.com/blankhaus/danger-klippain/main/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/blankhaus/danger-klippain/main/uninstall.sh | bash
```
